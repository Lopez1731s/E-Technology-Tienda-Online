<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Peripherals.aspx.cs" Inherits="Sistema_VentasBeta3.E_Tecnology.Categories.Peripherals" %>
    ...
    <div class="container animated fadeInUp">
            ...
            <div class="btn-group col-lg-2" style="position: relative; height: 2rem;">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <div class="nav-pills list-group" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="dropdown-item nav-link active" id="v-pills-teclado-tab" data-toggle="pill" href="#v-pills-teclado" role="tab" aria-controls="v-pills-teclado" aria-selected="false">Teclados</a>
						<a class="dropdown-item nav-link" id="v-pills-mouse-tab" data-toggle="pill" href="#v-pills-mouse" role="tab" aria-controls="v-pills-mouse" aria-selected="true">Mouse</a>
						<a class="dropdown-item nav-link" id="v-pills-speaker-tab" data-toggle="pill" href="#v-pills-speaker" role="tab" aria-controls="v-pills-speaker" aria-selected="false">Altavoces</a>
                    </div>
        ...
        <div class="row">
            <div class="tab-content" id="v-pills-tabContent">
				<div class="tab-pane fade show active" id="v-pills-teclado" role="tabpanel" aria-labelledby="v-pills-teclado-tab">
                    <div class="row">
                ...
                <div class="tab-pane fade" id="v-pills-mouse" role="tabpanel" aria-labelledby="v-pills-mouse-tab">
					<div class="row">
