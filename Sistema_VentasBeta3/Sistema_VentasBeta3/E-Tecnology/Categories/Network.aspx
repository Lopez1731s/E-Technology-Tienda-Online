<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Network.aspx.cs" Inherits="Sistema_VentasBeta3.E_Tecnology.Categories.Network" %>
    ...
    <div class="container animated fadeInUp">
            ...
            <div class="btn-group col-lg-2" style="position: relative; height: 2rem;">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <div class="nav-pills list-group" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="dropdown-item nav-link active" id="v-pills-bluetooth-tab" data-toggle="pill" href="#v-pills-bluetooth" role="tab" aria-controls="v-pills-bluetooth" aria-selected="false">USB Bluetooth</a>
						<a class="dropdown-item nav-link" id="v-pills-switch-tab" data-toggle="pill" href="#v-pills-switch" role="tab" aria-controls="v-pills-switch" aria-selected="true">Switch</a>
                    </div>
        ...
        <div class="row">
            <div class="tab-content" id="v-pills-tabContent">
				<div class="tab-pane fade show active" id="v-pills-bluetooth" role="tabpanel" aria-labelledby="v-pills-bluetooth-tab">
                    <div class="row">
                ...
                <div class="tab-pane fade" id="v-pills-switch" role="tabpanel" aria-labelledby="v-pills-switch-tab">
					<div class="row">
