<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="cooling.aspx.cs" Inherits="Sistema_VentasBeta3.E_Tecnology.Categories.cooling" %>
    ...
    <div class="container animated fadeInUp">
            ...
            <div class="btn-group col-lg-2" style="position: relative; height: 2rem;">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <div class="nav-pills list-group" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="dropdown-item nav-link active" id="v-pills-disipador-tab" data-toggle="pill" href="#v-pills-disipador" role="tab" aria-controls="v-pills-disipador" aria-selected="false">Disipadores</a>
						<a class="dropdown-item nav-link" id="v-pills-liquid-tab" data-toggle="pill" href="#v-pills-liquid" role="tab" aria-controls="v-pills-liquid" aria-selected="true">Enfriamiento liquido</a>
						<a class="dropdown-item nav-link" id="v-pills-fans-tab" data-toggle="pill" href="#v-pills-fans" role="tab" aria-controls="v-pills-fans" aria-selected="false">Ventiladores</a>
                    </div>
        ...
        <div class="row">
            <div class="tab-content" id="v-pills-tabContent">
				<div class="tab-pane fade show active" id="v-pills-disipador" role="tabpanel" aria-labelledby="v-pills-disipador-tab">
                    <div class="row">
                ...
                <div class="tab-pane fade" id="v-pills-fans" role="tabpanel" aria-labelledby="v-pills-fans-tab">
                    <div class="row">
